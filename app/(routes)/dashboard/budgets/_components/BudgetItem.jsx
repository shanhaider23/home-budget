...
function BudgetItem({ budget }) {
	...
	return (
		<Link
			...
			className="p-5 border rounded-lg shadow-lg bg-white hover:shadow-xl hover:scale-105 transition-all cursor-pointer"
		>
			{/* Top Section */}
			<div className="flex items-center justify-between">
				...
				<div className="flex items-center gap-4">
					...
					<div>
						...
						<p className="text-sm text-gray-500">{budget.totalItem} item(s)</p>
					</div>
				</div>
